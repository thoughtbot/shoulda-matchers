...
could not be proved.
  ...
  * attr2: ["can't be blank"]
      ...
      it 'reports failures for every attribute that fails' do
        ...
        message = <<-MESSAGE
Expected Example to validate that :attr1 cannot be empty/falsy and
validate that :attr2 cannot be empty/falsy, but this could not be
proved.
  After setting :attr1 to ‹""›, the matcher expected the Example to be
  invalid, but it was valid instead.
  After setting :attr2 to ‹""›, the matcher expected the Example to be
  invalid, but it was valid instead.
        MESSAGE
